...
function generateBranch(action, repositoryPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield util_1.execute(`git rm -rf .`);
            yield util_1.execute(`touch README.md`);
            yield util_1.execute(`git add README.md`);
            yield util_1.execute(`git commit -m "Initial ${action.branch} commit"`);
...
function deploy(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield util_1.execute(`git reset --hard origin/${action.branch}`);
        yield util_1.execute(`git checkout ${action.baseBranch || "master"}`);
        if (action.cname) {
